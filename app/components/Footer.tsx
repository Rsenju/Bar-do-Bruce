...
export default function Footer() {
  return (
    <footer>
      {/* Main footer */}
      <div
        className="bg-[#050505] border-t border-white/[0.06] px-[6%] py-14"
        style={{
          display: 'grid',
      ...
      >
        {/* Brand */}
        <div>
          <p className="font-playfair text-[1.3rem] font-black tracking-tight mb-3">
            Bar do <span className="text-accent">Bruce</span>
          </p>
          <p className="text-[0.82rem] text-gray-DEFAULT leading-[1.75] max-w-[260px]">
            Gastronomia baiana com sofisticação moderna no coração do Pelourinho, Salvador.
          </p>
          <div className="mt-5 flex gap-3">
            <a
              ...
              className="w-9 h-9 rounded border border-white/[0.1] flex items-center justify-center text-gray-DEFAULT hover:border-accent hover:text-accent transition-all duration-200"
              aria-label="WhatsApp"
            >
          ...
          <ul className="space-y-2.5">
            {navLinks.map(link => (
              <li key={link.href}>
                <a
                  href={link.href}
                  className="text-[0.85rem] text-gray-DEFAULT hover:text-white transition-colors duration-200"
                >
                  {link.label}
                </a>
              </li>
        ...
        <div>
          ...
          <a
            href="#reservas"
            className="btn-primary mt-5 text-[0.7rem] py-2.5 px-4"
          >
            Reservar Mesa
          </a>
        </div>
      ...
      {/* Bottom bar */}
      <div className="bg-[#030303] border-t border-white/[0.04] px-[6%] py-4 flex flex-wrap items-center justify-between gap-3">
